...
const sampleForm = <FieldSpec>[
  ...
  FieldSpec(name: "title", label: "Title", mandatory: false),
  FieldSpec(
  ...
  FieldSpec(
      name: "radio1", group: "Pronoun", value: "He", type: FieldType.radio),
  FieldSpec(
      name: "radio2", group: "Pronoun", value: "She", type: FieldType.radio),
  FieldSpec(
      name: "radio3",
      group: "Pronoun",
      value: "Unspecified",
